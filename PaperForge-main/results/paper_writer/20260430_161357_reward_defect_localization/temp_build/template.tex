...
\begin{axis}[
    ...
    ymin=0, ymax=100,
    symbolic x coords={Ours, LBT, CMT, LLMDirect, IRL},
    xtick=data,
...
\addplot[fill=blue!60] coordinates {(Ours,92.5) (LBT,32.5) (CMT,45.0) (LLMDirect,55.0) (IRL,62.5)};
\addplot[fill=red!60] coordinates {(Ours,7.5) (LBT,67.5) (CMT,55.0) (LLMDirect,45.0) (IRL,37.5)};
